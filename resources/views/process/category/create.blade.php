<form> 
    <div class="form-group">
        ...
        <input class="form-control" type="text" placeholder="Ex. Processos ADX">
    </div>
    ...
    <div class="form-group">
        ...
        <select class="form-control selectpicker" name="departments" data-live-search="true"  multiple>
    ...
    <div class="form-group">
        ...
        <select class="form-control selectpicker" name="users" data-live-search="true"  multiple>
